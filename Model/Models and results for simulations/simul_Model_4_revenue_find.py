...
CostPTShare_norm_change = DefineVariable('CostPTShare_norm_change', (0.9245*MarginalCostPT) * 1000/ApproxIncome)
...
PT = BETA_COST_SHARE_PT * CostPTShare_norm_change + BETA_TIME_PT * ((TimePT ** LAMBDA_TIME_PT) - 1)/LAMBDA_TIME_PT + BETA_Urban * URBAN + BETA_Student * STUDENT
