...
CostPTShare_norm_0.8 = DefineVariable('CostPTShare_norm_0.8', (0.8*MarginalCostPT)*1000/ApproxIncome)
CostPTShare_norm_0.85 = DefineVariable('CostPTShare_norm_0.85', (0.85*MarginalCostPT)*1000/ApproxIncome)
CostPTShare_norm_0.9 = DefineVariable('CostPTShare_norm_0.9',(0.9*MarginalCostPT)*1000/ApproxIncome)
CostPTShare_norm_0.95 = DefineVariable('CostPTShare_norm_0.95', (0.95*MarginalCostPT)*1000/ApproxIncome)
CostPTShare_norm_1.05 = DefineVariable('CostPTShare_norm_0.95', (1.05*MarginalCostPT)*1000/ApproxIncome)
CostPTShare_norm_1.1 = DefineVariable('CostPTShare_norm_1.1', (1.1*MarginalCostPT)*1000/ApproxIncome)
CostPTShare_norm_1.15 = DefineVariable('CostPTShare_norm_1.15', (1.15*MarginalCostPT)*1000/ApproxIncome)
CostPTShare_norm_1.2 = DefineVariable('CostPTShare_norm_1.2', (1.2*MarginalCostPT)*1000/ApproxIncome)
