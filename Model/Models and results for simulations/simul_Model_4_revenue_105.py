...
CostPTShare_norm_08 = DefineVariable('CostPTShare_norm_0.8', (0.8*MarginalCostPT) * 1000/ApproxIncome)
CostPTShare_norm_085 = DefineVariable('CostPTShare_norm_0.85', (0.85*MarginalCostPT) * 1000/ApproxIncome)
CostPTShare_norm_09 = DefineVariable('CostPTShare_norm_0.9',(0.9*MarginalCostPT) * 1000/ApproxIncome)
CostPTShare_norm_095 = DefineVariable('CostPTShare_norm_0.95', (0.95*MarginalCostPT) * 1000/ApproxIncome)
CostPTShare_norm_105 = DefineVariable('CostPTShare_norm_0.95', (1.05*MarginalCostPT) * 1000/ApproxIncome)
CostPTShare_norm_11 = DefineVariable('CostPTShare_norm_1.1', (1.1*MarginalCostPT) * 1000/ApproxIncome)
CostPTShare_norm_115 = DefineVariable('CostPTShare_norm_1.15', (1.15*MarginalCostPT) * 1000/ApproxIncome)
CostPTShare_norm_12 = DefineVariable('CostPTShare_norm_1.2', (1.2*MarginalCostPT) * 1000/ApproxIncome)
...
PT = BETA_COST_SHARE_PT * CostPTShare_norm_105 + BETA_TIME_PT * ((TimePT ** LAMBDA_TIME_PT) - 1)/LAMBDA_TIME_PT + BETA_Urban * URBAN + BETA_Student * STUDENT
...
# Increase revenue by 5%. Start by defining the revenue. 
rev_PT = MarginalCostPT*prob_PT
...
simulate = {'01 Revenue, PT': rev_PT,
	    '02 Market share, PT': prob_PT
}
