#COX TEST FOR COMPARING Model_2 AND Model_3
...
CAR = ASC_CAR * one + BETA_COST_CAR * CostCarCHF + BETA_COST_SHARE_CAR * CostCarShare_norm + BETA_TIME_CAR * TimeCar + BETA_NbCar * NbCars + BETA_NbChild * NbChildren + BETA_LANGUAGE * FrenchRegion + BETA_WorkTrip * WORK
