...
# PARAMETERS (from Model_2_param)

ASC_CAR = Beta('ASC_CAR',-0.405704,-10000,10000,0,'ASC_CAR' )
BETA_COST_SHARE_CAR = Beta('BETA_COST_SHARE_CAR',0,-10000,10000,0,'BETA_COST_SHARE_CAR' )
BETA_TIME_CAR = Beta('BETA_TIME_CAR',-0.0317558,-10000,10000,0,'BETA_TIME_CAR' )
LAMBDA_TIME_CAR = Beta('LAMBDA_TIME_CAR',1,-1000,1000,0,'LAMBDA_TIME_CAR' )
...
BETA_COST_SHARE_PT = Beta('BETA_COST_SHARE_PT',0,-10000,10000,0,'BETA_COST_SHARE_PT' )
LAMBDA_TIME_PT = Beta('LAMBDA_TIME_PT',1,-1000,1000,0,'LAMBDA_TIME_PT' )
...
ASC_DIST = Beta('ASC_DIST',-0.21187,-10000,10000,0,'ASC_DIST' )
BETA_DIST_YOUNG = Beta('BETA_DIST_YOUNG',0,-10000,10000,0,'BETA_DIST_YOUNG' )
BETA_DIST_ADULT = Beta('BETA_DIST_ADULT',0,-10000,10000,0,'BETA_DIST_ADULT' )
BETA_DIST_OLD = Beta('BETA_DIST_OLD',0,-10000,10000,0,'BETA_DIST_OLD' )
...
ASC_DIST_2 = Beta('ASC_DIST_2',-0.21187,-10000,10000,1,'ASC_DIST_2' )
...
CAR = (1.0 - ALFA) * CAR_4 + ALFA * CAR_2
PT = (1.0 - ALFA) * PT_4 + ALFA * PT_2
SM = (1.0 - ALFA) * SM_4 + ALFA * SM_2
